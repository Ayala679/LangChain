...
SYSTEM_PROMPT = SystemMessage(content=(
    ...
    "3. Present results as a FLAT NUMBERED LIST (1., 2., 3., ...). For each "
    "source provide, on its own lines: the title, the URL, a brief summary, and "
    "its relevance to the topic.\n"
    "4. Output ONLY the numbered list. No introduction, no closing remarks, no "
    "section headings or category groupings - just the numbered sources.\n"
